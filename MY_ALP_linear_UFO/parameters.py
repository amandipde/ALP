...
ctautau = Parameter(name = 'ctautau',
                nature = 'external',
                type = 'real',
                value = 1.,
                texname = '\\text{ctautau}',
